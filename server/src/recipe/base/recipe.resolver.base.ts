...
import { UserRecipeFindManyArgs } from "../../userRecipe/base/UserRecipeFindManyArgs";
...
export class RecipeResolverBase {
  ...
  @graphql.ResolveField(() => [UserRecipe])
  @nestAccessControl.UseRoles({
    resource: "Recipe",
    action: "read",
    possession: "any",
  ...
  async userRecipes(
    ...
    const results = await this.service.findUserRecipes(parent.id, args);
